---
name: trust-acquisition-playbook
description: Privacy-first trust and customer-acquisition tactics for SunRed.vip — the ranked, guest-anonymous playbook (Telegram testimonials, directory listings, trust badges, hard-banned tactics). Use when View asks how to get more trust, more customers, more reviews, or proposes a new marketing/acquisition idea that needs checking against the privacy rules.
---
