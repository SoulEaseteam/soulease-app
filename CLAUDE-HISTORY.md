# CLAUDE-HISTORY.md — SunRed build log (archive)

Round-by-round changelog moved out of CLAUDE.md on 2026-07-08 to keep that file lean.
Not loaded into session context. Newest entries are at the bottom of each block.
For live operational rules, brand voice, tech stack, and design decisions, see
CLAUDE.md (§1-8, §10-12).
