...
//
// Review-domain Cloud Functions: negative-review alerting + the shared
// text moderation callable.
...
import { TELEGRAM_BOT_TOKEN, OPENAI_API_KEY, TELEGRAM_CHAT_ID } from "./config";
