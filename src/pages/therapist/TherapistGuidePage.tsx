...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Profile",
        body: "ตั้งสถานะว่าง/ไม่ว่าง วันหยุด เวลาทำงาน ตำแหน่งที่ยืน และเข้าหน้าตั้งค่า",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "ตำแหน่งที่ยืน · Standby location",
        body: "จุดที่เราประจำอยู่ตอนว่าง ระบบใช้คำนวณค่าเดินทางและระยะทางให้ลูกค้า อัปเดตด้วย GPS ปัจจุบันได้ หรือกดกลับจุดประจำ ระบบจะรีเซ็ตกลับจุดประจำให้เองทุกวัน",
      },
      {
        title: "เวลาทำงาน",
