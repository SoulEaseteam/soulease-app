...
import { fmtBKKTimeShort } from "@/utils/time";
...
const AdminTherapistDetailPage: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    const patch: Record<string, unknown> = {
      ...
      // 🆕 28x.106b (founder "ถ้าไม่ใช่ auto ก็ทำงานตามคำสั่ง") — manual
      //   overrides NEVER auto-expire: no overrideUntil stamp means the
      //   engine keeps the override until the admin flips it back to Auto.
      //   (Supersedes both midnight-expiry and the brief 06:00 variant.)
      overrideUntil: null,
