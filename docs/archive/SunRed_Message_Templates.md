...
**How to use:**
- Save each template as a saved reply / quick-reply on WhatsApp Business and Telegram
- Send the closest-fit template, then personalize 1-2 sentences
- Aim to reply within 5 minutes — speed of reply is the #1 conversion factor for international travelers

---

## Section 1: First-Contact Inquiries
...
### 1.2 — Generic Inquiry (Mandarin / 中文)
...
✓ 持牌按摩师上门到您的酒店客房
✓ 覆盖曼谷 Sukhumvit、Silom、Sathorn、河边四大区域
...
### 1.3 — Price Inquiry (Direct Question)

```
Sure, here's our pricing — all prices are inclusive (travel, oils, sheets, therapist):

🌿 60 min — 1,800 THB (Aroma / Swedish)
🌿 90 min — 2,500-2,800 THB (Aroma / Deep Tissue / Swedish)
🌿 120 min — 3,500 THB (Aroma + Stretch / Combo)
🌿 Thai Massage 60/90 min — 1,500 / 2,200 THB
...
### 2.2 — Booking Confirmation (Mandarin)
...
按摩师将于 [TIME] 到达，提前5分钟会发消息通知您。

取消政策：服务前1小时以上免费取消；1小时内取消收50%费用；未到场全额收费。

如需调整，请直接联系我。期待见面 🙏
```

### 2.3 — "Therapist 5-min Away" Auto-Message
...
### 4.1 — Post-Session Thank You + Soft Review Ask

```
Hope you enjoyed the session with [THERAPIST] 🙏

Quick favor — if you have a moment, would you mind sharing a sentence about your experience? It really helps our small team:

📝 [GOOGLE REVIEW LINK]

Either way, thank you for choosing SunRed. We've saved your preferences (therapist, service, pressure) so next time you're in Bangkok, booking takes one message.

Safe travels back 🌏
```

### 4.2 — Repeat Customer Welcome Back
...
### 4.3 — VIP Repeat Customer (5+ Bookings)
...
## Section 5: Re-Engagement (Old Customers)
...
### 5.3 — Singapore Long-Weekend / Holiday Reminder (Targeted)

```
Hi [NAME] 👋

Quick heads-up — [SG HOLIDAY] is coming up [DATE] and a lot of our regulars from Singapore book Bangkok for the long weekend.

If you're considering it, our late-night availability is usually tight that weekend. Want me to put a tentative hold on [THERAPIST] for [DATE]? No commitment until you confirm flights.
```
...
## Section 7: Hotel Concierge / B2B Outreach

### 7.1 — Cold Outreach to Hotel Concierge (English)

```
Subject: Mobile massage referral partnership for [HOTEL] guests

Hi [CONCIERGE NAME],

I'm [YOUR NAME] from SunRed — a Bangkok-based mobile massage service for international business travelers (primarily Singapore, Hong Kong, and regional executives).

I'd love to discuss a referral partnership with [HOTEL]:

✓ Your guests get a vetted, discreet, late-night-available service when your spa is closed
✓ Therapists arrive in plain clothes, fully professional, no friction with hotel ops
✓ We pay 20% commission on all referred bookings, settled monthly via [PAYMENT METHOD]
✓ Your team gets a private number and priority dispatch

Would you have 15 minutes this week for a quick coffee at [HOTEL CAFE] so I can show you our service?
...
### 7.2 — Follow-Up with Concierge Who Hasn't Replied

```
Hi [NAME], following up briefly on my note last week.

Three things that might be useful for your guests:

1. Our late-night window (8pm-2am) when [HOTEL]'s spa is closed
2. Our English/Mandarin therapists for international guests
3. The 20% commission to your concierge team for referred bookings

Even a quick "no thanks" is fine — I just want to close the loop.
...
## Section 8: Forum / Community Engagement

### 8.1 — Reddit / Forum Reply (Helpful, Non-Promotional)
...
### 8.2 — Forum Self-Disclosure (When Appropriate)
...
## Section 9: Operational Quick-Replies

### 9.1 — "Are you available tonight?" (Quick Yes)

```
Yes 👍 What time and which hotel?
```

### 9.2 — "Are you available tonight?" (Quick No)

```
Sorry, fully booked tonight. Tomorrow is wide open — what time works?
```

### 9.3 — Customer Asking for Wrong Service (Couples / Spa Day / etc.)
...
### 9.4 — Customer Outside Service Area
...
### Where to install these templates:

**WhatsApp Business**
1. Open WhatsApp Business app
2. Settings → Business tools → Quick replies
3. Add a shortcut for each (e.g., `/welcome`, `/price`, `/confirm`, `/repeat`)
4. Type `/welcome` in any chat to insert template instantly

**Telegram**
1. Use the @SaveAsBot or built-in saved messages
2. For automated FAQ replies: ManyChat ($15/mo) integration with Telegram

**Make/Zapier Automation (advanced)**
- Trigger: New booking confirmed in your CRM/Firestore
- Action: Auto-send confirmation template via WhatsApp/Telegram API
- Saves you 5-10 min per booking

### Personalization Rules:

1. Always insert the customer's name (or nickname) in the first line
2. Always reference something specific from prior conversation (their hotel, their preferred therapist, their last visit date)
3. Never send identical messages to two different customers — Telegram/WhatsApp users notice form letters
4. Edit `[BRACKETS]` BEFORE sending. Half-finished templates kill your credibility.

### Reply Speed = Conversion Rate

The data on Bangkok mobile massage bookings:
- Reply within 2 minutes: 70-80% conversion to booking
- Reply within 10 minutes: 40-50% conversion
- Reply within 1 hour: 10-15% conversion
- Reply after 4 hours: customer has already booked someone else

For a solo operator, speed matters more than perfect copy. Use these templates as your speed advantage.
